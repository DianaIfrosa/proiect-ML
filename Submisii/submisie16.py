...
if __name__ == '__main__':
   ...
   # try n-grams on chars (find the best n between [3, 6])
    n_options = [x for x in range(3,7)]
    ...
    for lowercase_preprocessing in [False,True]:
        for n in n_options:
            ...
            for learning_rate_init_param in [ 0.001, 0.0001]:
                solution_index += 1
                ...
                f.write("Accuracy for learning rate " + str(learning_rate_init_param) +
    ...
    f.write("Best accuracy is for solution no. " + str(best_solution_index)  +
    ...
    best_model = MLPClassifier(early_stopping=True, learning_rate_init=best_learning_rate_init)
