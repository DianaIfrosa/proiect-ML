...
if __name__ == '__main__':
   ...
   # try n-grams on chars with the best parameters from a previous submision named "submisie13.py", but change batch size at the final fit 
    ...
    best_model = MLPClassifier(hidden_layer_sizes=(32,), early_stopping=False,
                                batch_size=64,learning_rate_init=0.0001, max_iter=model.n_iter_)
