...
if __name__ == '__main__':
    ...
    # use the best parameters from a previous submision, named 'submisie7.py', but with early_stopping True at the final fit
    ...
    best_model = MLPClassifier(hidden_layer_sizes=(32,), early_stopping=True, learning_rate_init=0.0001)
