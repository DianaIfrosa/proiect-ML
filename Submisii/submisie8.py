...
if __name__ == '__main__':
    ...
    # try n-grams on words (find the best n between [2, 7]) - upperbound for word n-gram
    ...
    for n in n_options:
        for preprocessing in [True, False]:
            vect = CountVectorizer(analyzer='word', lowercase=preprocessing, ngram_range=(1,n))
    ...
    vect = CountVectorizer(analyzer='word', lowercase=best_preprocessing, ngram_range=(1,best_n)) 
