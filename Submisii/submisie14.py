...
if __name__ == '__main__':
   ...
   # try n-grams on char with the second pair of the best parameters from a previous search, named 'NN n-gram on chars parameter search2.py'
    ...
    model = MLPClassifier(hidden_layer_sizes=(32,64), early_stopping=True,
                          batch_size=128, learning_rate_init=0.0001)
    ...
    f.write("Accuracy for hidden layers (32,64)" +
    ...
    best_model = MLPClassifier(hidden_layer_sizes=(32,64), early_stopping=False,
                                batch_size = 128, learning_rate_init=0.0001, max_iter=model.n_iter_)
